...
public function tools()
{
    return [
        // ...
        \Ivanderbu2\NovaBreadcrumbs\NovaBreadcrumbs::make(),
    ];
}
```
...
```php
use Ivanderbu2\NovaBreadcrumbs\Traits\Breadcrumbs;
...
public function tools()
{
    return [
        // ...
        \Ivanderbu2\NovaBreadcrumbs\NovaBreadcrumbs::make()->withoutStyles(),
    ];
}
```
